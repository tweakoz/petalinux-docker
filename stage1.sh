...
# for SpinalHDL # https://github.com/SpinalHDL/SpinalTemplateSbt
...
apt-get install -y -q openjdk-8-jdk openocd libftdi-dev
apt-get install -y -q libreadline-dev tcl tcl-dev clang
apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv 642AC823
apt-get update
apt-get install -y -q scala sbt
apt-get clean
